					...
					<div class="right-top-header">
						...
						<div class="login-register-wrap right-header-block">
							<?php if ( is_user_logged_in() ) { ?>
									<a href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') )); ?>" title="<?php esc_attr__('My Account','estore'); ?>" class="user-icon"><?php esc_html_e('Tài khoản', 'estore'); ?></a>
								<?php }
								else { ?>
									<a href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') )); ?>" title="<?php esc_attr__('Login/Register','estore'); ?>"class="user-icon"><?php esc_html_e('Đăng ký/ Đăng nhập', 'estore'); ?><i class="fa fa-angle-down"> </i></a>
								<?php } ?>
						</div>
						<?php endif;
			...
			<div class="wishlist-cart-wrapper clearfix">
				...
				if (function_exists('YITH_WCWL')) {
					...
					<div class="wishlist-wrapper">
						<a class="quick-wishlist" href="<?php echo esc_url($wishlist_url); ?>" title="Yêu thích">
					...
					<div class="cart-wrapper">
						<div class="estore-cart-views">
							...
							<div class="my-cart-wrap">
								<div class="my-cart"><?php esc_html_e('Tổng tiền', 'estore'); ?></div>
